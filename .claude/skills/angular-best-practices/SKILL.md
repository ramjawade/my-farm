...
description: TypeScript/Angular coding rules for this repo (components, signals, templates, services, data loading, accessibility). Load whenever writing or reviewing Angular code in projects/home or projects/shared.
---
